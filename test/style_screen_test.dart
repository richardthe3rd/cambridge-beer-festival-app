  ...
  group('StyleScreen', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(find.text('Style Not Found'), findsNothing);

        // The network recovers; tapping Retry re-loads and the style
        // renders normally.
        when(
          failingDrinkRepo.getDrinks(any),
        ).thenAnswer((_) async => [drink1, drink2]);
