...
class _VisibilityFilterButton extends StatelessWidget {
  final int activeCount;
  final VoidCallback onPressed;

  const _VisibilityFilterButton({
...
class _VisibilityFilterTile extends StatelessWidget {
  final String label;
